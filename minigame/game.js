...
const managerConfig = {
    DATA_FILE_MD5: '12aeb33cface74b4',
    CODE_FILE_MD5: '0d4591ccbdac46d1',
    GAME_NAME: 'webgl',
    APPID: 'wxdfe72aa8c7017a1c',
    DATA_FILE_SIZE: '9233998',
    OPT_DATA_FILE_SIZE: '$OPT_DATA_FILE_SIZE',
    DATA_CDN: 'https://a.unity.cn/client_api/v1/buckets/0d7910a3-89be-4c14-b1a5-5aaa6a55e597/release_by_badge/Dev/content/',
    // 资源包是否作为小游戏分包加载
